...
DEP_TARGETS ?= agent/agent.o util/util.o msa.o event/event.o event/handler.o event/dispatch.o input/input.o util/string.o cfg/cfg.o cmd/cmd.o log/log.o output/output.o util/var.o plugin/plugin.o
