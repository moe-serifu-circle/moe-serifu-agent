...
DEP_TARGETS ?= agent/agent.o util.o msa.o event/event.o event/handler.o event/dispatch.o input/input.o string.o configuration.o cmd/cmd.o log.o output.o var.o plugin.o
