...
class LocalClientTest(unittest.TestCase):
    ...
    def test_post(self):
        ...
        result = loop.run_until_complete(self.api_client.post("/test", payload=request_payload))
        expected = {
            "verb": "post",
    ...
    def test_put(self):
        ...
        result = loop.run_until_complete(self.api_client.put("/test", payload=request_payload))
        expected = {
            "verb": "put",
            "payload": request_payload
        }
    ...
    def test_delete(self):
        ...
        result = loop.run_until_complete(self.api_client.delete("/test", payload=request_payload))
        expected = {
            "verb": "delete",
            "payload": request_payload
        }
    ...
    def test_non_existant_route(self):
        ...
        self.assertEqual(
            "ApiLocalClient: no api route get:/test exists.",
            str(cm.exception)
        )
    ...
    def test_invalid_route(self):
        ...
        self.assertEqual(
            "ApiLocalClient: api route is not callable: 5",
            str(cm.exception)
        )
    ...
    def test_throwing_exception(self):
        ...
        self.assertTrue(
            "Exception: my_exception" in result.raw
        )
...
class WebsocketClientTest(unittest.TestCase):
    ...
    def tearDown(self):
        if (hasattr(self, "api_client") and
                hasattr(self.api_client, "disconnect")):
