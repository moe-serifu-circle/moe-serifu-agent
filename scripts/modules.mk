...
$(ODIR)/agent/agent.o: $(SDIR)/agent/agent.cpp $(SDIR)/agent/agent.hpp $(SDIR)/msa.hpp $(SDIR)/cfg/cfg.hpp $(SDIR)/agent/hooks.hpp $(SDIR)/log/log.hpp $(SDIR)/log/hooks.hpp $(SDIR)/output/output.hpp $(SDIR)/output/hooks.hpp $(SDIR)/var.hpp
...
$(ODIR)/output/output.o: $(SDIR)/output/output.cpp $(SDIR)/output/output.hpp $(SDIR)/msa.hpp $(SDIR)/cfg/cfg.hpp $(SDIR)/output/hooks.hpp $(SDIR)/log/log.hpp $(SDIR)/log/hooks.hpp $(SDIR)/string.hpp
