...
MSA_MODULE_HOOK(void, subscribe, msa::Handle msa, Topic, EventHandler)
MSA_MODULE_HOOK(void, unsubscribe, msa::Handle msa, Topic, EventHandler)
MSA_MODULE_HOOK(void, generate, msa::Handle msa, const Topic, void *args)
